...
def analizar_email():
    ...
    if texto == "":
        etiqueta_resultado.config(text="Por favor escribe un email", fg="black")
        return
    ...
    if resultado == "SPAM":
        ...
        etiqueta_resultado.config(text="✔️ NO SPAM", fg="green")
...
def main():
    ...
    boton = tk.Button(
        ventana,
        text="Analizar",
        command=analizar_email,
        bg="#4CAF50",   # COLOR CORREGIDO
        fg="white",
        padx=20,
        pady=5
    )
